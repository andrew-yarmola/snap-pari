    ...
    double          displacement_exp[])
{
    ...
    /* set up the displacements -- added by oag */ 
	...
	cusp->displacement_exp = displacement_exp[cusp->index]; 
	cusp->displacement = log(cusp->displacement_exp); 
      }
    }
