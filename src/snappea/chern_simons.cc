    ...
    Boolean         *Li2_error_flag)
{
    Complex         Fu;
    Tetrahedron     *tet;
    static const Complex    minus_i = Complex(0.0, -1.0);
    ...
    Boolean         *Li2_error_flag)
{
    ...
    static const Complex    pi_squared_over_6   = Complex(PI*PI/6.0, 0.0),
			    four_pi_i           = Complex(0.0, 4.0*PI),
			    minus_pi_i          = Complex(0.0, -PI),
			    log_minus_two_pi_i  = Complex(LOG_TWO_PI, -PI_OVER_2);
