...
static void     usual_algorithm(Triangulation *aTriangulation, int anM, int anL, MatrixInt22 *aChangeMatrixArray, int aNumCoefficients, int aFirstCoefficient, int aSecondCoefficient, int aThirdCoefficient);
...
static void usual_algorithm(
    ...
    int             anM,
    int             anL,
    MatrixInt22     *aChangeMatrixArray,
    ...
    Triangulation   *aTriangulation)
{
    ...
    static long         theCoefficientArray[2] = {2, 2};
    static AbelianGroup theAbelianGroup = {2, theCoefficientArray};
